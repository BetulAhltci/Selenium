...
public class C02_ZeroTest {
    ...
    public void test01() {
        ...
        //Sayfa acılamazsa bach tusuna basın
        driver.navigate().back();

        //6.Online Banking menüsünden Pay Billis Pay Bills sayfasina gidin
        ...
        WebElement mesajElementi=driver.findElement(By.xpath("//span[@title='$ 200 payed to payee sprint']"));
